    ...
    $("#btn_order_submit").click(function() {
        ...
        if (proceed) {
            ...
            $.post('onlineorder.php', post_data, function(response) {
                ...
                $("#result").hide().php(output).slideDown();
            }, 'json');
    ...
    $(document).ready(function() {
        ...
        if ($form.length > 0) {
            $('form.newsletter input[type="submit"]').bind('click', function(event) {
                ...
                if (validateEmail()) { register($form); } else { $("#result1").hide().php("<div class='alert-danger'>Please provide valid email address.</div>").slideDown(200); }
        ...
        success: function(data) {
            ...
            if (data.result != "success") {
                if (data.msg && data.msg.indexOf("already subscribed") >= 0) {
                    ...
                    $("#result1").hide().php(resultMessage).slideDown(200);
                } else {
